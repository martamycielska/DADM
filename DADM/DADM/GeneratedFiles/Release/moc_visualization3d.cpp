...
QT_MOC_LITERAL(5, 60, 11), // "addRenderer"
QT_MOC_LITERAL(6, 72, 8) // "Renderer"

    },
    "Visualization3D\0brain3D\0\0acceptThreshold\0"
    "sliderValueChanged\0addRenderer\0Renderer"
};
#undef QT_MOC_LITERAL
...
void Visualization3D::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->addRenderer((*reinterpret_cast< Renderer(*)>(_a[1]))); break;
        default: ;
        }
    }
}
